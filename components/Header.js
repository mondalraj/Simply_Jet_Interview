...
const Header = () => {
    return (
        <header className='navbar container max-w-screen-2xl mx-auto px-5 pt-10 mt-28 text-center'>
            <div className='text-4xl md:text-5xl font-bold tracking-wide pb-2'>
                The Best Way to
            </div>
            <div className='text-4xl md:text-5xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-br from-[#A5D9FF] to-[#7399FB]'>
            ...
            <button className='bg-[#2104D8] py-3 text-lg px-14 rounded-lg'>
                Try this app
            </button>
